...
local requirements={
    ...
    saving={'df.global.game.main_interface.options.open',
        ...
        'df.save_substage.Initializing',
        'df.interface_key.OPTIONS','df.interface_key.SELECT','df.options_context_type.MAIN_ADVENTURE',
    ...
    barter={'df.global.game.main_interface.adventure.barter.open',
        'df.global.game.main_interface.adventure.barter.buildlists',
        'df.civzone_type.Shop','dfhack.buildings.containsTile',
        'dfhack.units.isVisible','dfhack.units.isHidden','dfhack.items.getValue'},
    barter_submit={'dfhack.screen.readTile','dfhack.screen.getWindowSize',
        'dfhack.items.getContainedItems','dfhack.items.getContainer',
        'df.inv_item_role_type.Hauled','df.inv_item_role_type.Weapon'},
    ...
    unit_classifications={'dfhack.units.isDanger','dfhack.units.isGreatDanger','dfhack.units.isOpposedToLife',
        'dfhack.units.isAgitated','dfhack.units.isWildlife','dfhack.units.isTame','dfhack.units.isInvader',
        'dfhack.units.isUndead','dfhack.units.isCrazed'},
    ...
    mount={{path='df.adventure_movement_mountst.new',type='function'},
        {path='df.adventure_movement_dismountst.new',type='function'},
        {path='df.adventure_movement_claim_petst.new',type='function'},
        {path='df.adventure_movement_lead_animalst.new',type='function'},
        {path='df.adventure_movement_stop_lead_animalst.new',type='function'},
        'df.rider_positions_type.STANDARD','df.unit_relationship_type.RiderMount',
        'df.unit_relationship_type.PetOwner','df.unit_relationship_type.Draggee',
        'dfhack.units.isTame','dfhack.units.isPet','dfhack.units.isDead'},
...
function M.capabilities()
    ...
    out.features.barter_submit.adapter='native_barter_offer_and_character_button'
    out.features.barter_submit.limitation='Requires one visible English Trade button and exact item/currency transfers; containers and equipped sale items are rejected before selection'
    out.adapters={native_path={method='native_movement_command',
        ...
        saving={method='dfhack_quicksave',
            context='MAIN_ADVENTURE',
            completion='Native save closes and the requested world file is newly written',
            limitation='Named checkpoints use the native filename handler and save request; overwrite must be explicit. Save-and-quit and timeline decisions are separate objectives'},
